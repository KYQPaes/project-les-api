...
public class CompraModel {
	...
	@Column(name = "valor_troca", nullable = true, length = 50, columnDefinition = "default 'NULL'")
	public String valorTroca;
	...
	public String getValorTroca() {
		return valorTroca;
	}

	public void setValorTroca(String valorTroca) {
